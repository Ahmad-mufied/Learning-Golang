...
--	Berbeda dengan Go-Lang, di Go-Lang saat kita buat variable dengan tipe data tertentu, maka secara otomatis
	akan dibuatkan default value nya
...
func main() {
	var person map[string]string = NewMap("Ahmad")
